...
import com.example.proyecto1.Usuarios;
...
public class UsuarioBD {
    ...
    //return true si las credenciales son válidas, false en caso contrario.
        ...
        // Obtiene todos los datos de un usuario a partir de su correo institucional.
         // @return Un objeto Usuario si se encuentra, null si no.
        public Usuarios obtenerUsuarioPorCorreoInstitucional(String correoInstitucional) {
            // Consulta SQL para obtener todos los datos del perfil
        ...
        public boolean actualizarUsuario(Usuarios usuario) {
            // Consulta SQL para actualizar los campos modificables
            ...
            try (Connection conn = ConexionBDRegistro.getConnection();
                ...
                stmt.setString(2, usuario.getNumeroTelefono());
